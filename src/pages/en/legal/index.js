...
const EnLegalIndexPage = () => {
  return (
    <Layout language="en">
      ...
      <h2>Disclaimers for Salinas River Recreation Guide</h2>
      <p>
        All the information on this website -{' '}
        <a href="https://salinasriver.org">https://salinasriver.org</a> - is
        published in good faith and for general information purpose only.
        Salinas River Recreation Guide does not make any warranties about the
        completeness, reliability and accuracy of this information. Any action
        you take upon the information you find on this website (Salinas River
        Recreation Guide), is strictly at your own risk. Salinas River
        Recreation Guide will not be liable for any losses and/or damages in
...
export default EnLegalIndexPage
